...
ARG GOLANG_IMAGE=crpi-dzjyl2rfnlfugj1m.cn-shanghai.personal.cr.aliyuncs.com/frogclaw/base-golang:1.26.5-alpine
...
# Copy frontend source and build. LegalDocumentView.vue resolves the legal
# Markdown files beside frontend/ at /app/docs/legal/.
COPY frontend/ ./
