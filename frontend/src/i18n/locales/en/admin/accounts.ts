export default {
    accounts: {
      ...
      autoMonitor: '30-min monitor',
      autoMonitorHint: 'Every 30 minutes, run the same “hi” connection test for all non-disabled accounts. Successful accounts are recovered and scheduling is enabled again.',
      autoMonitorEnabled: '30-minute account monitoring enabled',
      autoMonitorDisabled: '30-minute account monitoring disabled',
      autoMonitorUpdateFailed: 'Failed to update account monitoring',
      autoMonitorRunNow: 'Run account monitoring now',
      autoMonitorRunSuccess: 'Account monitoring completed: {total} total, {succeeded} succeeded, {failed} failed',
      autoMonitorRunFailed: 'Failed to run account monitoring',
