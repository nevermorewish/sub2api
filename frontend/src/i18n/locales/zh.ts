  ...
  admin: {
    ...
    tlsFingerprintProfiles: {
      ...
      form: {
        ...
        generateFromParams: '按参数生成',
        generateFromParamsHint: '根据运行时和传输参数生成 Claude Code TLS 模板。严格匹配仍建议采集真实 ClientHello。',
        generateTemplate: '生成模板',
        generateAndCreate: '生成并创建模板',
        generated: '已生成模板并填入表单',
        generateFailed: '生成模板失败',
        generateCreateFailed: '根据参数创建模板失败',
        ...
        greaseMode: 'GREASE',
        greaseAuto: '自动',
        alpnOverride: 'ALPN 覆盖',
        mtlsEnabled: 'mTLS',
        customCAEnabled: '自定义 CA',
        name: '模板名称',
      ...
      createSuccess: '模板创建成功',
      generateCreateSuccess: '已根据参数创建模板',
      updateSuccess: '模板更新成功',
      deleteSuccess: '模板删除成功',
      loadFailed: '加载模板失败',
      saveFailed: '保存模板失败',
