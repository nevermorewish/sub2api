...
func (s *GatewayService) SnapshotUsageRequestHeaders(ctx context.Context, header http.Header) map[string]string {
...
type RecordUsageInput struct {
	...
	InboundRequestHeaders map[string]string  // 客户端进来的请求头
