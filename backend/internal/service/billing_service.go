...
func (s *BillingService) initFallbackPricing() {
	...
	// Kimi K3 international USD pricing: https://platform.kimi.ai/docs/pricing/chat-k3.md
	// Kimi Code bare aliases reuse this API Platform tier as a billing fallback.
...
func (s *BillingService) getFallbackPricing(model string) *ModelPricing {
	...
	// Kimi K3 matching is intentionally exact (or a path suffix), so unknown
	// models such as kimi-k30 and the Claude Code kimi-k3[1m] selector do not match.
