...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/auto-monitor", h.Admin.ScheduledTest.GetAccountAutoMonitor)
		accounts.PUT("/auto-monitor", h.Admin.ScheduledTest.UpdateAccountAutoMonitor)
		accounts.POST("/auto-monitor/run", h.Admin.ScheduledTest.RunAccountAutoMonitorNow)
