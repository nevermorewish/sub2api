...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.POST("/messages", func(c *gin.Context) {
			...
			case service.PlatformZhipu, service.PlatformDeepSeek, service.PlatformVolcEngine, service.PlatformAli, service.PlatformMoonshot, service.PlatformMimo, service.PlatformMiniMax, service.PlatformOpenCode:
