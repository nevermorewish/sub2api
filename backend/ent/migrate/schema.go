...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "inbound_request_headers", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "request_headers", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "tls_fingerprint", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "ip_address", Type: field.TypeString, Nullable: true, Size: 45},
		{Name: "error_status", Type: field.TypeString, Nullable: true, Size: 32},
