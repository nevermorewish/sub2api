...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, accountTestService, rateLimitService, accountRepository, settingRepository, configConfig)
	scheduledTestHandler := admin.NewScheduledTestHandler(scheduledTestService, scheduledTestRunnerService)
